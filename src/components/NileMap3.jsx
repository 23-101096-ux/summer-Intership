...
import eyeRa    from '../assets/eyenoolock.png';
    ...
    return (
        <div className="nile-map">
            ...
            <div className="nile-map__levels">
                ...
                <div className="nile-map__level" style={{ animationDelay: '0.6s' }}  onClick={() => navigate('/level2concept')}>
                ...
                <div className="nile-map__level" style={{ animationDelay: '0.8s' }} onClick={() => navigate('/level3concept')}>
                    <div className="nile-map__icon-wrap nile-map__icon-wrap--locked">
